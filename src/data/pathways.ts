...
export const pathways: Record<string, PathwayContent> = {
  ...
  "virtual-administrative-assistant": {
    ...
    rich: {
      badge: "Founding Cohort 2026 · Applications open",
      heroHeadline: "Build Evidence of Your Virtual Administrative Capability",
      heroLede:
        "Administrative work is judged on judgement: what you escalate, what you handle, what you protect. Complete assessed workplace simulations with competing priorities and produce the outputs that prove you can hold an operation together.",
      who: [
        { title: "Aspiring virtual assistants", body: "You are entering remote administrative work and need evidence of quality and judgement, not just a service description." },
        { title: "Administrators moving to remote or freelance work", body: "You have office-based experience and need portable, demonstrable evidence for clients who have never met you." },
        { title: "Career returners", body: "You are returning after a break and need recent, assessed evidence of current professional practice." },
        { title: "Executive and team assistants developing further", body: "You want assessed evidence of executive support, prioritisation and written communication at a higher level of complexity." },
      ],
      experienceLede: [
        "Each simulation drops you into an operational week: an inbox, a diary, a set of stakeholders and more requests than time. The situation, not the task list, is what you have to manage.",
        "You produce the outputs the role is judged on — a triaged inbox plan with reasoning, a workable schedule, an agenda, minutes that capture decisions, an action tracker that survives contact with reality.",
        "Simulations deliberately include conflicting priorities, incomplete information and requests that should be pushed back on. Knowing what to escalate, what to decline and what to protect is part of what is assessed.",
      ],
      processHeading: "How each simulation runs",
      process: [
        { n: "01", title: "Read the brief", body: "You receive a workplace scenario, the virtual administrative assistant context, the stakeholders and a defined set of Jobs to Be Done." },
        { n: "02", title: "Do the work", body: "You analyse the information, make professional decisions and produce the work outputs the role actually produces. The AI Simulation Assistant is available throughout." },
        { n: "03", title: "Get assessed", body: "You submit your work for AI and rubric-based competency assessment, and receive competency-level scoring, developmental feedback, a Readiness Score and an AI Voice Debrief." },
        { n: "04", title: "Own the evidence", body: "Your artefact is editable, partner-agnostic and yours to publish, edit and share — without a time limit." },
      ],
      situationsIntro:
        "Representative examples of the professional situations covered in this pathway. Organisations, stakeholders and data within simulations may be fictional, synthetic or representative of real professional environments.",
      situationsRich: [
        { ref: "Situation VA-01", title: "The inbox after annual leave", body: "An executive returns to a large backlog. Triage it, decide what needs their attention and what does not, draft the responses you would send on their behalf, and set out the reasoning for your prioritisation." },
        { ref: "Situation VA-02", title: "Four diaries, three time zones", body: "A decision meeting must happen this week across several senior calendars with genuine conflicts. Coordinate it, prepare the agenda and papers, and communicate the arrangements to everyone involved." },
        { ref: "Situation VA-03", title: "Minutes that have to hold up", body: "A meeting runs long, jumps between topics and ends without stating its decisions. Produce accurate minutes, extract the decisions and actions, assign owners and dates, and chase professionally." },
        { ref: "Situation VA-04", title: "A trip and an event in the same week", body: "International travel and a stakeholder event collide, and something has to give. Build the itinerary, coordinate the event, identify the clash early, and put a recommendation in front of the executive rather than an apology afterwards." },
      ],
      jtbd: [
        "Triage an inbox and justify the prioritisation",
        "Draft correspondence on somebody else's behalf, in their register",
        "Coordinate calendars across conflicting commitments and time zones",
        "Prepare a meeting: agenda, papers, logistics, attendees",
        "Take accurate minutes and capture decisions",
        "Build and maintain an action tracker, and chase owners",
        "Organise documents and information so others can find them",
        "Plan travel end to end, including contingency",
        "Research a topic and brief concisely",
        "Communicate with customers and stakeholders professionally",
        "Prioritise competing tasks and say what will not happen",
        "Support projects and events under time pressure",
        "Handle confidential information appropriately",
      ],
      artefactsRich: [
        { ref: "VA-01", name: "Prioritised inbox plan" },
        { ref: "VA-02", name: "Calendar schedule" },
        { ref: "VA-03", name: "Meeting agenda" },
        { ref: "VA-04", name: "Meeting minutes" },
        { ref: "VA-05", name: "Action tracker" },
        { ref: "VA-06", name: "Travel itinerary" },
        { ref: "VA-07", name: "Research brief" },
        { ref: "VA-08", name: "Stakeholder email" },
        { ref: "VA-09", name: "Document-management structure" },
        { ref: "VA-10", name: "Event coordination plan" },
        { ref: "VA-11", name: "Weekly operations report" },
        { ref: "VA-12", name: "Executive support plan" },
      ],
      competenciesLede:
        "Competencies are scored at competency level against defined rubrics, so your portfolio shows where you are strong and where you are still developing.",
      assessmentLede:
        "AI-powered competency assessment using expert-designed or expert-validated rubrics. Assessment is applied consistently against defined criteria, and completing a simulation does not guarantee a pass.",
      assessment: [
        { n: "Criterion 01", title: "Is the prioritisation defensible?", body: "Triage and planning outputs are assessed on the reasoning behind the order of work, not simply on whether everything was addressed." },
        { n: "Criterion 02", title: "Is the written work fit to send?", body: "Correspondence and minutes are assessed for accuracy, tone, register and whether they could go out on behalf of a professional without editing." },
        { n: "Criterion 03", title: "Was the right thing escalated?", body: "Rubrics look at judgement: what you handled, what you escalated, what you declined, and whether confidentiality was respected." },
      ],
      assessmentClosing:
        "You receive competency-level scoring, detailed developmental feedback, a Readiness Score and an AI Voice Debrief for every completed simulation.",
      journey: [
        {
          ...
          ordinal: "Stage 1 of 3",
          title: "Apply free for this pathway",
          body: "Submit a free application and select Virtual Administrative Assistant as your primary discipline. Programme access is free and carries no obligation to purchase credits.",
          items: ["Free application", "Founding Cohort 2026", "No obligation to purchase credits"],
        },
        {
          phase: "Prove",
          ordinal: "Stage 2 of 3",
          title: "Complete assessed virtual administrative assistant simulations",
          body: "Work through realistic professional briefs, produce the work outputs the discipline is judged on and submit them for competency-based assessment.",
          items: ["Realistic workplace scenarios", "Defined Jobs to Be Done", "Competency scoring and developmental feedback"],
        },
        {
          ...
          ordinal: "Stage 3 of 3",
          title: "Publish the evidence",
          body: "Your assessed virtual administrative assistant artefacts become part of a digital career portfolio you own, edit and share.",
          items: ["Portfolio artefacts", "Digital credentials", "CV and LinkedIn evidence support"],
        },
      ],
      costSubLede:
        "You can apply to the Virtual Administrative Assistant pathway, create your account and access the programme at no cost. Credits are required when you use AI-powered simulation, evaluation and portfolio-generation features.",
      faqRich: [
        { q: "Is this a role where I will be given real clients?", a: "No. This is work experience delivered through simulation. The executives, organisations and correspondence within simulations may be fictional, synthetic or representative. You are not performing work for an actual employer or client." },
        { q: "Is administrative work suitable for portfolio evidence?", a: "Yes, and it is often under-evidenced. Clients and employers rarely see the reasoning behind good administrative work. Assessed artefacts such as a triage plan with justification, or minutes that hold up, make that judgement visible." },
        { q: "Do I need specific software?", a: "No. Artefacts are produced as professional documents rather than inside a particular email, calendar or project tool, so they stay portable across whatever your future client or employer uses." },
        { q: "Can this help me move into project work?", a: "Many participants use it as a first step. Subject to available simulations, the common progression is Virtual Administrative Assistant into project coordination work and then Project Management." },
        { q: "Will spelling and formatting be assessed?", a: "Yes, as part of attention to detail and written communication. In this discipline the quality of the document is part of the professional output, not incidental to it." },
      ],
      ctaLede:
        "Applications for the Virtual Administrative Assistant pathway are open to the 2026 founding cohort. Programme access is free; AI usage requires credits.",
    },
  },
};
