      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            <label className="text-[10px] font-medium uppercase tracking-[0.18em] text-white/40">
              Full name
            </label>
            <input
              type="text"
    ...
    >
      ...
      >
        ...
        <p className="text-sm text-white/50 leading-[1.8] mb-8">
          We&apos;ve received your enrolment details. A member of the Career Bridge team will be in touch within a few minutes to confirm your cohort place.
        </p>
...
export default function CtiPage() {
  ...
  // Detect Stripe redirect with ?success=1
  useEffect(() => {
  ...
  return (
    <>
      {/* Post-payment overlays */}
      <AnimatePresence>
        {showForm && !showModal && (
          <SuccessForm onSuccess={() => { setShowForm(false); setShowModal(true); }} />
        )}
        {showModal && (
